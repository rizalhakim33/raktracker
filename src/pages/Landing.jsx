  ...
  return (
    <div className="min-h-screen bg-background text-text-main">
      ...
      <section className="relative overflow-hidden border-b border-border" style={{background:"linear-gradient(165deg, #FFFFFF 0%, #E8F3F7 40%, #D6EBF0 100%)"}}>
        ...
        <div className="relative max-w-6xl mx-auto px-4 md:px-6 py-16 md:py-24 text-center max-w-3xl">
          ...
          <p className="mt-5 text-[16px] leading-7 text-text-secondary max-w-[52ch] mx-auto">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-6 text-[13px] font-medium text-text-secondary">
